...
#define CONFIG_DEBUG_ERR_MSG 1
#define CONFIG_DEBUG_WARN_MSG 1
#define CONFIG_DEBUG_INFO_MSG 1
#define error_printf(fmt, ...) rtl_printf(fmt, ##__VA_ARGS__)
#define warning_printf(fmt, ...) rtl_printf(fmt, ##__VA_ARGS__)
...
#define CONFIG_WDG_ON	10000 // ms
#define CONFIG_WDG_ON_IDLE 1 // WDG_Refresh() in  vApplicationIdleHook();
