...
#if DEBUGSOO > 0
const uint8_t txt_tcpsrv_NULL_pointer[] TCP_SRV_RODATA_ATTR = "tcpsrv: NULL pointer!\n";
const uint8_t txt_tcpsrv_already_initialized[] TCP_SRV_RODATA_ATTR = "tcpsrv: already initialized!\n";
const uint8_t txt_tcpsrv_out_of_mem[] TCP_SRV_RODATA_ATTR = "tcpsrv: out of mem!\n";
#endif
 ...
 * Returns      : tcp error
 ******************************************************************************/
err_t TCP_SRV_CODE_ATTR tcpsrv_int_sent_data(TCP_SERV_CONN * ts_conn, uint8_t *psent, uint16_t length) {
	err_t err = ERR_ARG;
 ...
 * Returns      : err_t
 ******************************************************************************/
static err_t TCP_SRV_CODE_ATTR recv_trim_bufi(TCP_SERV_CONN * ts_conn, uint32_t newadd)
{
	uint32_t len = 0;
 ...
 *******************************************************************************/
TCP_SERV_CFG * TCP_SRV_CODE_ATTR tcpsrv_server_port2pcfg(uint16_t portn) {
	TCP_SERV_CFG * p;
...
/******************************************************************************
 tcpsrv_init server.
 *******************************************************************************/
TCP_SERV_CFG * TCP_SRV_CODE_ATTR tcpsrv_init(uint16_t portn) {
	//	if (portn == 0)	portn = 80;
...
/******************************************************************************
 tcpsrv_close_port
 *******************************************************************************/
err_t TCP_SRV_CODE_ATTR tcpsrv_close_port(uint16_t portn)
{
