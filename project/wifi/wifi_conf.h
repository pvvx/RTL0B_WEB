...
int _wifi_connect(
	...
	int 				key_id,
	void 				*semaphore);
#define wifi_connect(ssid, security_type, password, ssid_len, password_len, key_id, semaphore) \
	_wifi_connect((unsigned char *) 0, 0, ssid, security_type, password, key_id, semaphore)
/* 
int wifi_connect(
	char 				*ssid,
	rtw_security_t	security_type,
 ...
 */
#define wifi_connect_bssid(bssid, ssid, security_type, password, bssid_len, ssid_len, password_len, key_id, semaphore) \
	_wifi_connect(bssid, 1, ssid, security_type, password, key_id, semaphore)	
/*
...
#define wifi_start_ap(ssid, security_type, password, ssid_len, password_len, channel) \
	_wifi_start_ap(ssid, security_type, password, channel, 0)
/*
int wifi_start_ap(
	char 				*ssid,
	rtw_security_t		security_type,
 ...
 * @return  RTW_ERROR: If an error occurred.
 */
#define wifi_start_ap_with_hidden_ssid(ssid, security_type, password, ssid_len, password_len, channel) \
	_wifi_start_ap(ssid, security_type, password, channel, 1)
/*
 ...
 * @note  Please make sure the Wi-Fi is enabled before invoking this function. (@ref wifi_on())
 */
int _wifi_restart_ap(
	unsigned char *ssid,
	rtw_security_t security_type,
	unsigned char *password,
	int channel);
#define wifi_restart_ap(ssid, security_type, password, ssid_len, password_len, channel) \
		_wifi_restart_ap(ssid, security_type, password, channel)
/*
int wifi_restart_ap(
	unsigned char 		*ssid,
	rtw_security_t		security_type,
